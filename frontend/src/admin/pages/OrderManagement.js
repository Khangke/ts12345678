        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex space-x-2">
              ...
              <div className="bg-blue-100 dark:bg-blue-900/50 px-3 py-2 rounded-lg">
                <div className="text-xs text-blue-600 dark:text-blue-400">Đã xử lý</div>
                <div className="text-lg font-bold text-blue-800 dark:text-blue-400">{processedCount}</div>
              </div>
              <div className="bg-green-100 dark:bg-green-900/50 px-3 py-2 rounded-lg">
                <div className="text-xs text-green-600 dark:text-green-400">Đã giao</div>
                <div className="text-lg font-bold text-green-800 dark:text-green-400">{deliveredCount}</div>
              </div>
            </div>
          </div>
        </div>
