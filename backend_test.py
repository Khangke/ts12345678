...
BACKEND_URL = "https://910b4083-f5a3-4068-bb35-acd817bca407.preview.emergentagent.com"
...
def run_tests():
    ...
    print(f"{Colors.HEADER}{'=' * 80}{Colors.ENDC}")
    print(f"{Colors.HEADER}TESTING BACKEND APIs AFTER CONTACT FORM CSS FIX{Colors.ENDC}")
    ...
    if test_results['failed'] > 0:
        ...
        print(f"{Colors.OKGREEN}Backend is not affected by the contact form CSS fix.{Colors.ENDC}")
